...
aws s3api create-bucket --bucket rameshkumarrec69836.k8s.local --region us-east-1
aws s3api put-bucket-versioning --bucket rameshkumarrec69836.k8s.local --region us-east-1 --versioning-configuration Status=Enabled
export KOPS_STATE_STORE=s3://rameshkumarrec69836.k8s.local
kops create cluster --name rameshkumarrec69836.k8s.local --zones us-east-1a --master-count=1 --master-size t2.large --node-count=2 --node-size t2.large
kops update cluster --name rameshkumarrec69836.k8s.local --yes --admin
